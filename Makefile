...
SRCS = main.c \
	   ...
	   helpers/lib/ft_strlen.c helpers/lib/ft_strchr.c  helpers/lib/ft_strlcpy.c helpers/lib/ft_isdigit.c helpers/lib/ft_atoi.c helpers/lib/ft_isalpha.c helpers/lib/ft_isalnum.c\
