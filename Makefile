...
NAME = cub3D
SRCS = main.c \
	   helpers/free_tab.c helpers/goodbye.c helpers/ini.c helpers/xpm_to_img.c helpers/print_error.c helpers/is_space.c helpers/close_game.c \
	   render/dda.c render/render_images.c render/raycasting.c render/render_frame.c\
	   helpers/lib/ft_strlen.c helpers/lib/ft_strchr.c helpers/lib/ft_strdup.c helpers/lib/ft_strjoin.c  helpers/lib/ft_strlcpy.c helpers/lib/ft_isdigit.c helpers/lib/ft_atoi.c helpers/lib/ft_isalpha.c helpers/lib/ft_isalnum.c\
